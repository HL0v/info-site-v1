    ...
    <section className="relative -mt-45 pt-52 pb-20 px-4 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10 text-center">
        <h1 className="text-5xl md:text-7xl font-bold text-(--primary-text) mb-6 leading-tight">
          Nossas <span className="bg-linear-to-r from-(--highlighted-text) to-(--royal-blue) bg-clip-text text-transparent">Soluções</span>
        </h1>
        <p className="text-xl md:text-2xl text-(--secondary-text) max-w-3xl mx-auto font-medium leading-relaxed">
          Unimos a tradição de 33 anos da UNESP Rio Claro com as tecnologias mais modernas do mercado para entregar resultados excepcionais.
        </p>
      </div>
    </section>
  );
